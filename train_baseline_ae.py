...
sys.path.append(".")
from idm_source import datasets
from idm_source import models
from idm_source.models.dsbn import convert_dsbn, convert_bn
from idm.models.idm_dsbn import convert_dsbn_idm, convert_bn_idm
from idm_source.models.xbm import XBM
from idm_source.trainers import Baseline_Trainer, IDM_Trainer
from idm_source.evaluators import Evaluator, extract_features
from idm_source.utils.data import IterLoader
from idm_source.utils.data import transforms as T
from idm_source.utils.data.sampler import RandomMultipleGallerySampler
from idm_source.utils.data.preprocessor import Preprocessor
from idm_source.utils.logging import Logger
from idm_source.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict
...
def create_model(args):
    ...
    checkpoint = torch.load('./logs/baseline_0102_823/model_best.pth.tar')
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        model.module.classifier.weight.data[args.s_class:args.s_class + args.t_class].copy_(
        ...
        if ((epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1)):
            ...
            save_checkpoint({
                ...
                'epoch': epoch + 1,
                'best_mAP': best_mAP,
            }, is_best, fpath=osp.join(args.logs_dir, 'checkpoint_ae.pth.tar'))
